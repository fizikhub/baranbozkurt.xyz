...
- Preserve the main Baran portfolio at `/`; Ertan Çelik's demo is a separate `/ertancelik/` page. Its approved direction is quiet executive minimalism: white, black and neutral gray only; real supplied photography; no campaign-style giant slogans, colored blocks, fullscreen menus, decorative effects, card grids, gradients, or conspicuous scroll choreography. Mobile is a dedicated single-column composition and motion stays brief, accessible, and compositor-friendly.
