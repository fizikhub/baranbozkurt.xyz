...
- Preserve the main Baran portfolio at `/`; Ertan Çelik's demo is a separate `/ertancelik/` page. The direction is a quiet documentary profile: system typography, broad white space, one dominant portrait, a factual short biography, and one black information section. Avoid campaign language, decorative branding, colored accents, card grids, gradients, fullscreen navigation, and scroll choreography. Mobile is a dedicated single-column composition; motion is limited to the opening load.
